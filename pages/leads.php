...
while ($row = db_fetch_assoc($result))
{
    ...
    elseif ($row['lead_status'] == 'new') {
        $converttxt = " - <a href='$path_to_root/modules/FA_CRM/pages/convert_lead.php?lead_id=" . $row['id'] . "' onclick=\"javascript:openWindow(this.href,'convertLead','width=600,height=400');return false;\">" . _("Convert") . "</a>";
    }
